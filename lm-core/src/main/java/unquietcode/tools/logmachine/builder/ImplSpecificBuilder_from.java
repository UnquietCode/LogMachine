...
public class ImplSpecificBuilder_from
    implements BuilderImplementation, SpecificBuilder_from
{

    private final SpecificHelper _helper;
    private final Object _returnValue;

    ImplSpecificBuilder_from(SpecificHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public SpecificBuilder_from with(String key, String value) {
        _helper.with(key, value);
         
        return this;
    }

    public SpecificBuilder_from with(String key, Number value) {
        _helper.with(key, value);
    ...
    public SpecificBuilder from(String location) {
