...
public interface GenericBuilder_debug_error_info_to_trace_warn_with_with$A<_ReturnType >{
    ...
    GenericBuilder_debug_error_info_trace_warn_with_with$A<_ReturnType> to(Enum... categories);

    _ReturnType trace(String message, Object... data);

    _ReturnType warn(String message, Object... data);

    GenericBuilder_debug_error_info_to_trace_warn_with_with$A<_ReturnType> with(String key, Number value);

    GenericBuilder_debug_error_info_to_trace_warn_with_with$A<_ReturnType> with(String key, String value);
