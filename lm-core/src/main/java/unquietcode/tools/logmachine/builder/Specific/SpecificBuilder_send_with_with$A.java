...
public interface SpecificBuilder_send_with_with$A<_ReturnType >{


    _ReturnType send(String message, Object... data);

    SpecificBuilder_send_with_with$A<_ReturnType> with(String key, Number value);

    SpecificBuilder_send_with_with$A<_ReturnType> with(String key, String value);
