...
public interface GenericBuilder_debug_error_info_trace_warn_with_with$A<_ReturnType >{
    ...
    GenericBuilder_debug_error_info_trace_warn_with_with$A<_ReturnType> with(String key, Number value);

    GenericBuilder_debug_error_info_trace_warn_with_with$A<_ReturnType> with(String key, String value);
