...
public interface GenericBuilder_to<_ReturnType >{


    void warn(String message, Object... data);

    GenericBuilder<_ReturnType> to(Enum... categories);

    void info(String message, Object... data);

    GenericBuilder_to<_ReturnType> with(String key, Number value);
    ...
    GenericBuilder_to<_ReturnType> with(String key, String value);
