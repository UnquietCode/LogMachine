...
public class ImplGenericBuilder_because_debug_error_info_to_trace_warn_with_with$A
    implements BuilderImplementation, GenericBuilder_because_debug_error_info_to_trace_warn_with_with$A
{

    private final GenericHelper _helper;
    private final Object _returnValue;

    public ImplGenericBuilder_because_debug_error_info_to_trace_warn_with_with$A(GenericHelper helper, Object returnValue) {
        _helper = helper;
    ...
    public GenericBuilder_debug_error_info_to_trace_warn_with_with$A because(Throwable cause) {
    ...
    public GenericBuilder_because_debug_error_info_trace_warn_with_with$A to(Enum... categories) {
    ...
    public GenericBuilder_because_debug_error_info_to_trace_warn_with_with$A with(String key, Number value) {
        _helper.with(key, value);
         
        return this;
    }

    public GenericBuilder_because_debug_error_info_to_trace_warn_with_with$A with(String key, String value) {
        _helper.with(key, value);
