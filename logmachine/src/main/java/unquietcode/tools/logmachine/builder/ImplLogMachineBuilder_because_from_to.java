    ...
    implements BuilderImplementation, LogMachineBuilder_because_from_to
{
    ...
    ImplLogMachineBuilder_because_from_to(LogMachineHelper helper, BuilderImplementation returnValue) {
        _helper = helper;
    ...
    public LogMachineBuilder_from_to because(Throwable cause) {
        ...
        LogMachineBuilder_from_to retval = new ImplLogMachineBuilder_from_to(_helper, _returnValue);
    ...
    public LogMachineBuilder_because_to from(String location) {
        ...
        LogMachineBuilder_because_to retval = new ImplLogMachineBuilder_because_to(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }
    ...
    public LogMachineBuilder_because_from to(Enum... categories) {
        ...
        LogMachineBuilder_because_from retval = new ImplLogMachineBuilder_because_from(_helper, _returnValue);
        _transferInvocations(retval);
        return retval;
    }
